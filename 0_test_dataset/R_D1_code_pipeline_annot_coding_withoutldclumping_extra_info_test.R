...
output_common <- c()
for (i in 1:nstud){output_common[i] <- paste("D1_output_pipeline", input_shortname[i], "common2all", nstud, "studies", "coding_wo_clumping", sep="_")}

# used for steps #2 & #3
output_names <- paste("output_pipeline", output_step4wc, sep="_")

# used for steps #3 & #4
output_names_summary <- c()
for (i in 1:nstud){output_names_summary[i] <- paste("D1_Summary_SNP_in_genes", "output_pipeline", input_shortname[i], "common2all", nstud, "studies", "coding_wo_clumping", sep="_")}
