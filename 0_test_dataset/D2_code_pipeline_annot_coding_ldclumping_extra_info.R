...
output_common <- c(paste("D2_output_pipeline",opt$name1,"common",opt$name2,"coding_clumping",sep="_"),
                   paste("D2_output_pipeline",opt$name2,"common",opt$name1,"coding_clumping",sep="_"))

# used for steps #2 & #3
output_names <- paste("output_pipeline",opt$out,sep="_")

# used for steps #3 & #4 & #5
output_names_summary <- c(paste("D2_Summary_SNP_in_genes","output_pipeline",opt$name1,opt$name2,"coding_clumping",sep="_"),
                          paste("D2_Summary_SNP_in_genes","output_pipeline",opt$name2,opt$name1,"coding_clumping",sep="_"))
...
gwas_SNP_in_gene_iput_file <- paste0("D2_output_pipeline_SNP_in_genes_", output_names, ".txt")
...
gwas5_extra_annot_columns_selected <- gwas5_extra_annot_columns[ , c("snp", "chr", "pos_hg19", 
                                                                     "Effect_A.y", "Baseline_A.y", "beta", "se",
