...
Second, you need to change the parameters on the ([*"GCPBayes_pipeline_parameters.R"*](../0_Codes/R)) file. You just easily open this file in RStudio or a text editor and chenge the required parameters. Here are some recommendations:
