...
Matrix_input_file <- paste("D1_Matrices_output_pipeline_BCAC_OCAC_coding_withoutclumping.Rdata",sep="")
Matrix_extra_info_input_file <- paste("D1_Matrices_extra_info_output_pipeline_BCAC_OCAC_coding_withoutclumping.Rdata",sep="")
...
for(i in 1:ngenes){
  ...
  #genename <- names(Genes_with_SNP_number_less_than_threshold)[i]
  #------------------------------------------------
