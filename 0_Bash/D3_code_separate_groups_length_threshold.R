...
# Without clumping
load(paste0(path_input_data_read,"Matrices_output_pipeline_",opt$file_noclump,".Rdata"))
load(paste0(path_input_data_read,"Matrices_extra_info_output_pipeline_",opt$file_noclump,".Rdata"))
Matrix_in_noclump <- gcpbayes_input_data_final
Matrix_in_noclump_extra_info <- gcpbayes_extra_input_data_final
# With clumping
load(paste0(path_input_data_read,"Matrices_output_pipeline_",opt$file_clump,".Rdata"))
load(paste0(path_input_data_read,"Matrices_extra_info_output_pipeline_",opt$file_clump,".Rdata"))
...
save(gcpbayes_input_data_final, file=paste0(path_output_data, "Matrices_output_pipeline_", opt$out_noclump, ".Rdata"))
save(gcpbayes_extra_input_data_final, file=paste0(path_output_data, "Matrices_extra_info_output_pipeline_", opt$out_noclump,".Rdata"))

# Save .RData long genes
gcpbayes_input_data_final <- out_clump
gcpbayes_extra_input_data_final <- out_clump_extra
save(gcpbayes_input_data_final, file=paste0(path_output_data, "Matrices_output_pipeline_", opt$out_clump, ".Rdata"))
save(gcpbayes_extra_input_data_final, file=paste0(path_output_data, "Matrices_extra_info_output_pipeline_", opt$out_clump,".Rdata"))
