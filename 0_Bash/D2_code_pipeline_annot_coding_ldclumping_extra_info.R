...
output_common <- c(paste("output_pipeline",opt$name1,"common",opt$name2,"coding_clumping",sep="_"),
                   paste("output_pipeline",opt$name2,"common",opt$name1,"coding_clumping",sep="_"))

# used for steps #2 & #3
output_names <- paste("output_pipeline",opt$out,sep="_")

# used for steps #3 & #4 & #5
output_names_summary <- c(paste("Summary_SNP_in_genes","output_pipeline",opt$name1,opt$name2,"coding_clumping",sep="_"),
                          paste("Summary_SNP_in_genes","output_pipeline",opt$name2,opt$name1,"coding_clumping",sep="_"))
