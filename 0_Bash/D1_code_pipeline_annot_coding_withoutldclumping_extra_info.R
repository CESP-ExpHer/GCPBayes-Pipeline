...
output_common <- c(paste("output_pipeline",opt$name1,"common",opt$name2,"coding_withoutclumping",sep="_"),
                   paste("output_pipeline",opt$name2,"common",opt$name1,"coding_withoutclumping",sep="_"))

# used for steps #2 & #3
output_names <- paste("output_pipeline",opt$out,sep="_")

# used for steps #3 & #4
output_names_summary <- c(paste("Summary_SNP_in_genes","output_pipeline",opt$name1,opt$name2,"coding_withoutclumping",sep="_"),
                          paste("Summary_SNP_in_genes","output_pipeline",opt$name2,opt$name1,"coding_withoutclumping",sep="_"))
...
vroom_write(gwas_common_gene_added, file = paste0(path_output_data, "output_pipeline_SNP_in_genes_", output_names, ".txt"), 
...
gwas_SNP_in_gene_input_file <- paste0("output_pipeline_SNP_in_genes_", output_names, ".txt")
