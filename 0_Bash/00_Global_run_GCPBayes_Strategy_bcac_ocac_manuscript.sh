#===============================================================================
#           USAGE:  ./00_Global_run_GCPBayes_Strategy_bcac_ocac_manuscript.sh
#
#     DESCRIPTION:  global codes to run the GCPBayes pipeline modified based on BCAC_2020 and OCAC GWAS Sum Stat Data (encapsulate all the different procedures in one code, with a global specification of the parameters for the user)
#
#===============================================================================
...
theta_plot=0.5
group_clump_threshold=700 # More longer groups will be "ld-clumped" before analysis (if clumping is FALSE, then they will not be performed)
