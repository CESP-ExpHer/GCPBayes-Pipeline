...
# Modified by: Yazdan Asgari, P.E Sugier
...
data_dir=sys.argv[1]
# '/home1/0_DATA_REF/1_GWAS_DataSets/1_Raw_data/1_Cancer/1_BCAC/GWAS_Summary_Associations_Breast_Cancer_Risk_2020/'
print(data_dir)
...
print(output_dir)
# '/home1/6_AMLAP/GCPBayes/Pipeline/results_bcac_vs_ocac/'
# ================================================================================
...
# column 21: SNP_ID (rs... or chr:pos:Baseline_A:Effect_A) (Baseline_A=non-Effect Allele, Effect_A=Effect Allele)
# column 22: chr
# column 23: position
