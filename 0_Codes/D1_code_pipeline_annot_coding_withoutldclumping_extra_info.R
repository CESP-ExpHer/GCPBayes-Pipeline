...
# Second GWAS Annotation file (used for step #4)
...
output_shared <- c("output_pipeline_BCAC_ALL_Shared_OCAC_coding_withoutclumping",
                   "output_pipeline_OCAC_Shared_BCAC_ALL_coding_withoutclumping")

# used for steps #2 & #3
output_names <- "output_pipeline_BCAC_ALL_OCAC_coding_withoutclumping"

# used for steps #3 & #4
output_names_summary <- c("output_pipeline_Summary_SNP_in_genes_BCAC_ALL_OCAC_coding_withoutclumping",
