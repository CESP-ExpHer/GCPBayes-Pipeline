...
Matrix_input_file <- paste("D3_Matrices_output_pipeline_",output_step5wc,".Rdata",sep="")
Matrix_extra_info_input_file <- paste("D3_Matrices_extra_info_output_pipeline_",output_step5wc,".Rdata",sep="")

# PATH for writing output files
path_data_write = path_output_data

output_names <- c(paste(output_step6wc,"less_threshold",group_clump_threshold,"errors",sep="_"),
				  paste(output_step6wc,"less_threshold",group_clump_threshold,"results",sep="_"),
				  paste(output_step6wc,"less_threshold",group_clump_threshold,"pleiotropy",sep="_"))
