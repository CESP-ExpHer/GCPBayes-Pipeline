...
# ================================================================================
# PATH in which GCPBayes input files exist
path_input_data_read = "~/BCAC_OCAC/"

# GCPBayes input file names
Matrix_input_file <- "Matrices_output_pipeline_BCAC_ALL_OCAC_coding_clumping_08.Rdata"
Matrix_extra_info_input_file <- "Matrices_extra_info_output_pipeline_BCAC_ALL_OCAC_coding_clumping_08.Rdata"

# PATH for writing output files
path_data_write = "~/BCAC_OCAC/"

# output file name
output_names <- c("output_GCPBayes_BCAC_All_OCAC_coding_ldclumping_08_less_threshold_500_errors",
